...
public class DepositGUI implements MouseListener{
    ...
    public DepositGUI(JPanel panel){
    
        this.panel = panel;
    }
    public void setDepositGUI(){
    ...
    public void mouseClicked(MouseEvent me) {
        ...
        if(me.getSource() == back) {
            ...
            DepositOtherAmountGUI depositOtherAmountGUI = new DepositOtherAmountGUI(panel);
            depositOtherAmountGUI.setDepositOtherAmountGUI();
            ...
            ObjectInputStream objectIn = new ObjectInputStream(credentialsIn)) {
                ...
                if (userCredentials.wallet.balance > 500000) {
                    ...
                    userCredentials.statement = "You received 500 PKR.";
                    ...
                    JOptionPane.showMessageDialog(null, "The amount of 500 has been successfully credited to your account.");
            ...
            ObjectInputStream objectIn = new ObjectInputStream(credentialsIn)) {
                ...
                if (userCredentials.wallet.balance > 500000) {
                    ...
                    JOptionPane.showMessageDialog(null, "The amount of 1000 has been successfully credited to your account.");
            ...
            ObjectInputStream objectIn = new ObjectInputStream(credentialsIn)) {
                ...
                if (userCredentials.wallet.balance > 500000) {
                    ...
                    JOptionPane.showMessageDialog(null, "The amount of 2000 has been successfully credited to your account.");
            ...
            ObjectInputStream objectIn = new ObjectInputStream(credentialsIn)) {
                ...
                if (userCredentials.wallet.balance > 500000) {
                    ...
                    JOptionPane.showMessageDialog(null, "The amount of 5000 has been successfully credited to your account.");
