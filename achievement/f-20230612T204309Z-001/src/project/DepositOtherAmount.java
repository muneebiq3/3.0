...
import java.awt.*;
public class DepositOtherAmount {
    ...
    private JButton accountDetails, bankStatement, transaction, deposit;
    
    private Cursor defaultCursor, hoverCursor;
    
    public DepositOtherAmount(JPanel panel){
    
        this.panel = panel;
    }
    public void setDepositOtherAmount(){
        ...
        deposit.setBounds(210, 240, 80, 20);
        deposit.setFont(deposit.getFont().deriveFont(10f));
        panel.add(deposit);
